...
Route::middleware('guest')->group(function () {
    ...
    // 2FA Routes (Technical guest because not fully logged in yet)
    ...
    Route::post('2fa/process', [App\Http\Controllers\Auth\TwoFactorController::class, 'process'])->name('2fa.process');

    // Google SSO Routes
    Route::get('auth/google', [App\Http\Controllers\Auth\GoogleAuthController::class, 'redirect'])->name('google.login');
    Route::get('auth/google_callback', [App\Http\Controllers\Auth\GoogleAuthController::class, 'callback'])->name('google.callback');
