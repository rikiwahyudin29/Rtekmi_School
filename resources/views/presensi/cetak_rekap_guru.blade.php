...
<head>
    ...
    <title>Cetak Rekap Kehadiran Guru</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="judul">
        REKAPITULASI KEHADIRAN INDIVIDU (GURU/STAFF)
    </div>

    <table style="border:none; margin-bottom: 15px;">
        <tr style="border:none;">
            <td style="border:none; text-align:left; width: 15%;"><b>Nama Guru</b></td>
            <td style="border:none; text-align:left; width: 2%;">:</td>
            <td style="border:none; text-align:left;">{{ $nama_guru }}</td>
        ...
        <tr style="border:none;">
            <td style="border:none; text-align:left;"><b>NIK/NIP</b></td>
            <td style="border:none; text-align:left;">:</td>
            <td style="border:none; text-align:left;">{{ $guru->nik ?? '-' }}</td>
            <td style="border:none; text-align:left;"><b></b></td>
            <td style="border:none; text-align:left;"></td>
            <td style="border:none; text-align:left;"></td>
        </tr>
    </table>
    ...
    <table style="width: 50%; margin: 0 auto 20px auto;">
        ...
        <tbody>
            ...
            <tr><td class="text-left">Izin/Dinas Luar (I/DL)</td><td>{{ $total['I'] }} Hari</td></tr>
