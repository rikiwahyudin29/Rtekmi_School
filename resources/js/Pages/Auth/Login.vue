            ...
            <div class="max-w-md w-full mx-auto my-auto">
                ...
                <form @submit.prevent="triggerLogin">
                    ...
                    <div class="relative flex items-center justify-center mt-8 mb-6">
                        ...
                        <span class="absolute bg-white px-3 text-xs text-gray-400 font-bold uppercase tracking-wider">Atau Masuk Dengan</span>
                    </div>

                    <!-- Social Buttons -->
                    <div class="grid grid-cols-1 gap-4">
                        <button type="button" @click="$inertia.get('/auth/google')" class="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-100 text-gray-700 hover:bg-gray-50 hover:border-gray-200 font-bold py-3 px-4 rounded-xl transition-all shadow-sm">
