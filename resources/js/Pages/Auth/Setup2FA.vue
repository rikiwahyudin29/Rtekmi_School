    ...
    <div class="min-h-screen flex w-full font-sans bg-gray-50">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-between p-8 sm:p-12 lg:p-16 bg-white relative">
            ...
            <div class="max-w-md w-full mx-auto my-auto text-center">
                <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight mb-2">Setup 2-Langkah</h2>
                <p class="text-sm text-gray-500 font-medium mb-6">
                    Pindai kode QR di bawah menggunakan aplikasi Google Authenticator, lalu masukkan kode 6-digit.
                </p>

                <div class="flex justify-center mb-6">
                    <div class="p-3 bg-white border-2 border-blue-100 rounded-2xl shadow-sm inline-block relative overflow-hidden group">
                        <img :src="qr_image" alt="QR Code" class="w-36 h-36 relative z-10">
