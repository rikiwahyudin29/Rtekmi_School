...
const previewFoto = ref(props.siswa.foto && props.siswa.foto !== 'default.png' ? `/uploads/siswa/${props.siswa.foto}` : null);
...
const submit = () => {
    form.post(`/admin/siswa/${props.siswa.id}`, {
        preserveScroll: true,
        forceFormData: true,
    });
};
        ...
        <div class="py-8">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="font-bold text-2xl text-gray-900 dark:text-white tracking-tight">Edit Data Siswa</h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Perbarui informasi <span class="font-semibold text-primary-600">{{ siswa.nama_lengkap }}</span></p>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="md:row-span-3 flex flex-col items-center">
                                <div class="w-36 h-36 rounded-3xl bg-gray-100 dark:bg-gray-700 overflow-hidden border-2 border-dashed border-gray-300 dark:border-gray-600 mb-3 flex items-center justify-center">
                                    <img v-if="previewFoto" :src="previewFoto" @error="previewFoto = null" class="w-full h-full object-cover">
